			...
			<div class="searchbox" id="queryContion">
				<div class="layui-form-item" style="margin-top: 10px;margin-bottom: 0px;">
					...
					<div class="layui-inline marginB16">
						...
						<div class="layui-input-inline" style="width: 120px">					
							<input type="text" name="sbssqq" id="sbssqq" class="layui-input layui-date-input" defualtValue="{CMD1}" />
						</div>
						<label class="layui-form-label label-left" style="width:20px">&nbsp;-</label>
						<div class="layui-input-inline" style="width: 120px">
						<input type="text" name="sbssqz" id="sbssqz" class="layui-input layui-date-input" defualtValue="{NOWDATE}"/>
						</div>
					</div>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="dataList">
						<tbody>
							<tr class="trheader">	
								...
								<th ng-cloak width="180px">征收品目</th>
							...
							<tr class="noData" ng-cloak ng-if="formData.length <= 0">
					      		<td colspan="14" align="center"><font color="red">没有数据!</font></td>
					   		</tr>
						</tbody>
					</table>
				</div>
