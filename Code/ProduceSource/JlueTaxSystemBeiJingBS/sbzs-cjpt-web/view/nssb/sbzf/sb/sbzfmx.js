...
window.onload=function(){ 
	...
	$.ajax({
		type : "post",
		url : "getsbzfmx.do?pzxh="+pzxh+"&gdslxDm="+gdslxDm+"&skssqq="+skssqq+"&skssqz="+skssqz+"&djxh="+djxh+"&nsrsbh="+nsrsbh+"&zgswjgDm="+zgswjgDm+"&swjgDm="+swjgDm+"&sbblxDm="+sbblxDm,
		data : {},
...
function zfSubmit() {
	...
	if(sqzfly == "" || sqzfly == null || re.test(sqzfly)){
		parent.layer.alert('请填写作废原因', {icon: 5});
		return;
	}
	//错误原因
	param.sqzfly = sqzfly;
