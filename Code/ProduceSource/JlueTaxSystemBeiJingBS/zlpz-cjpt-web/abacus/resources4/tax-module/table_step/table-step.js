...
$(document).ready(function(){
    ...
    if(myform.length > 0){
        ...
        var innerHTML = "<div class=\"table-step-main\">\n" +
            ...
            "</div>";
        //当跳过PDF页时，只显示三个步骤
        var makeTypeForm = $('#makeType', parent.document).val();
        if(makeTypeForm && makeTypeForm === 'HTML' ){	//拼装浮框div内容
            innerHTML = "<div class=\"table-step-main\">\n" +
                "\t\t<p class=\"float-icon\">进度</p>\n" +
                "\t\t<div class=\"table-step-center\">\n" +
                "\t\t\t<div class=\"table-step-item\">\n" +
                "\t\t\t\t<div class=\"pro-step finish-step\">\n" +
        ...
        //在得到的第一个元素之前插入浮框div
        if(!(parent.$("#ywbm").val()==="xbqytcsq")){//新办套餐不显示进度条
